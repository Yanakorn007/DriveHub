...
<body>
    ...
    <div class="container mt-5">
        ...
        <p>CarHub เป็นแพลตฟอร์มออนไลน์ที่ช่วยให้ผู้ใช้สามารถขายและซื้อรถมือสองได้อย่างสะดวกสบาย โดยเรามุ่งมั่นที่จะให้ข้อมูลที่แม่นยำและเชื่อถือได้ เพื่อให้ลูกค้าของเราสามารถทำการตัดสินใจที่ดีที่สุดในการเลือกซื้อรถมือสองที่มีคุณภาพสูง.</p>
        <h4>วิสัยทัศน์</h4>
        <p>เราเชื่อว่าการซื้อรถมือสองไม่ควรเป็นเรื่องที่ยาก เรามีเป้าหมายที่จะสร้างตลาดรถมือสองที่โปร่งใสและเป็นธรรมให้กับลูกค้าทุกคน.</p>
    </div>
