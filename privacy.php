...
<head>
    ...
    <title>นโยบายความเป็นส่วนตัว - CarHub</title>
...
<body>
    ...
    <div class="container mt-5">
        ...
        <h4>1. ข้อมูลที่เรารวบรวม</h4>
        <p>เรารวบรวมข้อมูลที่จำเป็นสำหรับการให้บริการเว็บไซต์ เช่น ข้อมูลการติดต่อ ข้อมูลการใช้งานเว็บไซต์ เป็นต้น.</p>

        <h4>2. การใช้ข้อมูลส่วนบุคคล</h4>
        <p>ข้อมูลที่เรารวบรวมจะถูกใช้เพื่อปรับปรุงการบริการและให้บริการที่เหมาะสมกับผู้ใช้.</p>

        <h4>3. การแชร์ข้อมูล</h4>
        <p>เราจะไม่แชร์ข้อมูลส่วนบุคคลของผู้ใช้กับบุคคลภายนอกโดยไม่ได้รับความยินยอมจากผู้ใช้เว้นแต่เป็นไปตามกฎหมายหรือข้อตกลงที่เราแจ้งไว้.</p>
    </div>
